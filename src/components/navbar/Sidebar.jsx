...
import Language from "../navbar/Lang"; // Asegúrate de que la ruta sea correcta
      ...
      {isOpen && (
        ...
        <div className="relative flex items-center justify-between">
            <img
              ...
              className="h-10 mb-8"
            />
            {/* Aquí colocamos el componente Language con la posición top-4 left-10 */}
            <div className="absolute -top-2 right-10">
              <Language isScrolled={false} />
            </div>
          </div>
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4">
          ...
          <AnimatedIcon isOpen={isOpen} onClick={toggleMenu} iconColor={isScrolled ? "black" : "white"} />
        </div>
      </motion.div>
