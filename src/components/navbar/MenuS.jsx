    ...
    <div>
      <div
        className={`lg:hidden fixed top-0 left-0 w-full z-50 ${
          isScrolled ? "bg-color-bg" : "bg-color-bg"
        } p-4 flex items-center justify-between`}
      >
        <motion.div className="xl:hidden rounded-full left-6 z-40">
          <img className="w-10 h-10" src={logo} alt="Alux Immo" />
        </motion.div>
        {/* Mobile Button and Favorites Icon */}
        <div className="xl:hidden flex items-center space-x-4">
          <div className="relative flex items-center">
            <motion.div
              className="text-stone-500 shadow-2xl rounded-md p-1 cursor-pointer"
          ...
          >
            {isOpen ? (
              <AiOutlineClose size={24} color="stone" />
            ) : (
              <CiMenuFries size={24} color="stone" />
            )}
          </motion.div>
        </div>
      </div>
        ...
        {isOpen && (
          ...
          >
            ...
            >
              <motion.li
                variants={menuItemVariants}
                className="text-stone-400 p-4 font-light text-2xl lg:text-3xl uppercase"
              ...
              {/* <li className="items-center justify-center object-center">
                <Lang className="text-stone-400" />
              </li> */}
              <motion.li
                variants={menuItemVariants}
                className="text-stone-500 mt-24 flex items-center space-x-5 justify-center"
              >
                <a
