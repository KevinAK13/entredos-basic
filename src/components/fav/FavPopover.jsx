...
const FavoritesPopover = () => {
  ...
  return (
    <div className="absolute top-full mt-2 -right-6 w-64 bg-black text-center rounded-sm overflow-hidden shadow-sm z-50">
      {favorites.length === 0 ? (
        ...
        <div>
          {favorites.map((property) => (
            <Link
              ...
              className="block p-2 border-b border-gray-900 hover:bg-stone-800 transition-all ease-in-out"
            >
